    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (pdus != null) {
            ...
            for (int i = 0; i < msgs.length; i++) {
                ...
                SmsReceiverConterller SRC = new SmsReceiverConterller(context);
                SRC.setReceivePhone(msgs[i].getOriginatingAddress().toString());
                SRC.setReceiveMessage(msgs[i].getMessageBody().toString());
